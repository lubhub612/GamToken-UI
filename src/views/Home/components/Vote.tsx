  ...
  return (
    <Card>
      <CardContent>
        ...
        <Spacer />
        {!delegated ? (
          <Button text="Delegate to save GAM" onClick={handleVoteClick} />
        ) : (
          <div>
            <StyledDelegatedCount>Delegating: {Number(delegatedBalance.multipliedBy(scalingFactor).toFixed(0)).toLocaleString()} GAM</StyledDelegatedCount>
        ...
        <div style={{
          ...
          <p>NOTE: You must harvest your GAMs BEFORE 7am UTC Thursday 8/13 - very soon.</p>
          <p>Hold them in your wallet until 10PM UTC Sunday 8/16 for your delegation to save GAM</p>
        </div>
          <div style={{
            display: 'flex',
            alignItems: 'center',
